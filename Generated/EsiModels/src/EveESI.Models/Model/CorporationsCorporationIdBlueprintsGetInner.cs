...
namespace EveESI.Models.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CorporationsCorporationIdBlueprintsGet_inner")]
    public partial class CorporationsCorporationIdBlueprintsGetInner
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CorporationsCorporationIdBlueprintsGetInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CorporationsCorporationIdBlueprintsGetInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CorporationsCorporationIdBlueprintsGetInner" /> class.
        /// </summary>
        /// <param name="itemId">Unique ID for this item. (required).</param>
        /// <param name="locationFlag">Type of the location_id (required).</param>
        /// <param name="locationId">References a station, a ship or an item_id if this blueprint is located within a container. (required).</param>
        ...
        public CorporationsCorporationIdBlueprintsGetInner(long itemId = default(long), LocationFlagEnum locationFlag = default(LocationFlagEnum), long locationId = default(long), long materialEfficiency = default(long), long quantity = default(long), long runs = default(long), long timeEfficiency = default(long), long typeId = default(long))
        {
            this.ItemId = itemId;
        ...
        /// </summary>
        /// <value>References a station, a ship or an item_id if this blueprint is located within a container.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CorporationsCorporationIdBlueprintsGetInner {\n");
