...
namespace EveESI.Models.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PostCharactersCharacterIdMailLabels_request")]
    public partial class PostCharactersCharacterIdMailLabelsRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostCharactersCharacterIdMailLabelsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PostCharactersCharacterIdMailLabelsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostCharactersCharacterIdMailLabelsRequest" /> class.
        /// </summary>
        /// <param name="color">Hexadecimal string representing label color, in RGB format (default to ColorEnum.Ffffff).</param>
        /// <param name="name">name (required).</param>
        public PostCharactersCharacterIdMailLabelsRequest(ColorEnum? color = ColorEnum.Ffffff, string name = default(string))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PostCharactersCharacterIdMailLabelsRequest and cannot be null");
            }
            this.Name = name;
            this.Color = color;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostCharactersCharacterIdMailLabelsRequest {\n");
