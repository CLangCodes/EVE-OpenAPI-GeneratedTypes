...
namespace EveESI.Models.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CharactersCharacterIdIndustryJobsGet_inner")]
    public partial class CharactersCharacterIdIndustryJobsGetInner
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CharactersCharacterIdIndustryJobsGetInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CharactersCharacterIdIndustryJobsGetInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CharactersCharacterIdIndustryJobsGetInner" /> class.
        /// </summary>
        ...
        public CharactersCharacterIdIndustryJobsGetInner(long activityId = default(long), long blueprintId = default(long), long blueprintLocationId = default(long), long blueprintTypeId = default(long), long completedCharacterId = default(long), DateTime completedDate = default(DateTime), double cost = default(double), long duration = default(long), DateTime endDate = default(DateTime), long facilityId = default(long), long installerId = default(long), long jobId = default(long), long licensedRuns = default(long), long outputLocationId = default(long), DateTime pauseDate = default(DateTime), double probability = default(double), long productTypeId = default(long), long runs = default(long), DateTime startDate = default(DateTime), long stationId = default(long), StatusEnum status = default(StatusEnum), long successfulRuns = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CharactersCharacterIdIndustryJobsGetInner {\n");
