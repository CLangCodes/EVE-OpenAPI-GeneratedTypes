...
namespace EveESI.Models.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CorporationsProjectsDetailConfigurationlostship")]
    public partial class CorporationsProjectsDetailConfigurationlostship
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CorporationsProjectsDetailConfigurationlostship" /> class.
        /// </summary>
        ...
        public CorporationsProjectsDetailConfigurationlostship(List<CorporationsProjectsDetailConfigurationdamageshipIdentitiesInner> identities = default(List<CorporationsProjectsDetailConfigurationdamageshipIdentitiesInner>), List<CorporationsProjectsDetailConfigurationcapturefwcomplexLocationsInner> locations = default(List<CorporationsProjectsDetailConfigurationcapturefwcomplexLocationsInner>), List<CorporationsProjectsDetailConfigurationdamageshipShipsInner> ships = default(List<CorporationsProjectsDetailConfigurationdamageshipShipsInner>))
        {
