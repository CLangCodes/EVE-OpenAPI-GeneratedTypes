...
<a id="getstatus"></a>
# **GetStatus**
> StatusGet GetStatus (DateOnly xCompatibilityDate, string? acceptLanguage = null, string? ifNoneMatch = null, string? xTenant = null)
...
namespace Example
{
    public class GetStatusExample
    {
        public static void Main()
        {
            ...
            {
                // Retrieve the uptime and player counts
                StatusGet result = apiInstance.GetStatus(xCompatibilityDate, acceptLanguage, ifNoneMatch, xTenant);
...
{
    // Retrieve the uptime and player counts
    ApiResponse<StatusGet> response = apiInstance.GetStatusWithHttpInfo(xCompatibilityDate, acceptLanguage, ifNoneMatch, xTenant);
...
{
    Debug.Print("Exception when calling StatusApi.GetStatusWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
