# EveESI.Models.Model.SovereigntyCampaignsGetInner
...
**CampaignId** | **long** | Unique ID for this campaign. | 
**ConstellationId** | **long** | The constellation in which the campaign will take place.  | 
**DefenderId** | **long** | Defending alliance, only present in Defense Events  | [optional] 
...
**SolarSystemId** | **long** | The solar system the structure is located in.  | 
